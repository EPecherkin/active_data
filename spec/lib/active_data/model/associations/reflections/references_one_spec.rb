...
describe ActiveData::Model::Associations::Reflections::ReferencesOne do
  context 'discovery' do
    ...
    describe '#persistence_adapter' do
      before do
        stub_const 'ActiveData::Model::Associations::PersistanceAdapters::ActiveRecord', Module.new
      end
      ...
      context 'by default' do
        ...
        it { is_expected.to eq ActiveData::Model::Associations::PersistanceAdapters::ActiveRecord }
      end
    end
  end
